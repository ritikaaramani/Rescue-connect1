                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.verified_user, color: kAccent),
                              const SizedBox(width: 12),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('Route Reliability Scaling', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                                    const Text('Model 2 — Active & Optimized', style: TextStyle(color: kAccent, fontSize: 12)),
                              ...
                              const Text('88%', style: TextStyle(color: kAccent, fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        )
                      ],
