...
class UberMapScreen extends ConsumerStatefulWidget {
  ...
  const UberMapScreen({super.key, this.initialPickup, this.initialDropoff});
...
class _UberMapScreenState extends ConsumerState<UberMapScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Auto-fill and auto-analyze if launched from dispatch
      if (widget.initialPickup != null && widget.initialDropoff != null) {
